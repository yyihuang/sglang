...
def _build_video_sampling_params(request_id: str, request: VideoGenerationsRequest):
    ...
    kwargs = {
        ...
        "wan_hybrid_abba_benchmark": request.wan_hybrid_abba_benchmark,
...
async def create_video(
    ...
    wan_hybrid_abba_benchmark: Optional[bool] = Form(None),
    ...
    if is_multipart:
        ...
        req = VideoGenerationsRequest(
            ...
            wan_hybrid_abba_benchmark=form_value(
                "wan_hybrid_abba_benchmark", wan_hybrid_abba_benchmark
            ),
