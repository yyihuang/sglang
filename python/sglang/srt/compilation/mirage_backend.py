...
def build_mirage_model_config(
    ...
    mirage_model_config = MirageModelConfig(
        ...
        local_num_q_heads=model_config.get_num_attention_heads(tp_size),
        local_num_kv_heads=model_config.get_num_kv_heads(tp_size),
...
def build_mpk_metadata(
    ...
    mirage_model_config = build_mirage_model_config(
        model_config,
        state_dict,
        k_cache_tensors,
        v_cache_tensors,
...
class MirageBackend:
    ...
    def __init__(
        ...
        self.compilation_config = compile_config
    ...
    def __call__(
        ...
        self.compilation_config.compilation_time += dynamo_time # todo(Yingyi): skip it?
        ...
        def compile_or_call(*args):
            ...
            logger.info("[Mirage] Calling the compiled result...")
            return self.mpk()
